...
The JSONL functions in BazerUtils (`read_jsonl`, `stream_jsonl`, `write_jsonl`) are deprecated. Use [JSON.jl](https://github.com/JuliaIO/JSON.jl) v1 instead, which has native support:
